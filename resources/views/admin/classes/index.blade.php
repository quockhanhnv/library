			...
			<tr>
				...
				<td data-field="" class="m-datatable__cell">
					<span style="overflow: visible; position: relative; width: 120px;">						
						...
						<a href="javascript:;" onclick="comfirmRemove('{{route('class.remove',['id' => $element->id])}}')" data-value="42" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill m-btn--delete" title="Xóa">								
